...
begin
  ...
  try
    ...
    SQL.SQL.Add('	COALESCE(FORN.PERCENTUAL_VPC, 0.00) AS PERCENTUAL_VPC,');
    SQL.SQL.Add('	COALESCE(FORN.PERCENTUAL_FRETE, 0.00) AS PERCENTUAL_FRETE,');
    ...
    SQL.SQL.Add('LEFT JOIN FORNECEDOR FORN ON (P.ID_FORNECEDORNOVO = FORN.ID)');
