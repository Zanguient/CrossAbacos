object FrmCadastroMargem: TFrmCadastroMargem
  ...
  object pnEdicao: TPanel
    ...
    object Panel1: TPanel
      ...
      object gbEstoqueFisico: TGroupBox
        AlignWithMargins = True
        Left = 7
        Top = 118
        Width = 245
        Height = 203
        Caption = ' Margem Estoque F'#237'sico '
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
        Font.Name = 'Tahoma'
        ...
        object edFisicoMinima: TDBEdit
          Left = 16
          Top = 68
          Width = 177
          Height = 27
          DataField = 'FISICOMINIMA'
          DataSource = dsPesquisa
          TabOrder = 0
        end
        object edFisicoMaxima: TDBEdit
          Left = 16
          Top = 136
          Width = 177
          Height = 27
          DataField = 'FISICOMAXIMA'
          DataSource = dsPesquisa
          TabOrder = 1
        end
      end
      object gbEstoqueVirtual: TGroupBox
        AlignWithMargins = True
        Left = 258
        Top = 118
        Width = 245
        Height = 203
        Caption = ' Margem Estoque Virtual '
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
        Font.Name = 'Tahoma'
        ...
        object edVirtualMinima: TDBEdit
          Left = 24
          Top = 68
          Width = 177
          Height = 27
          DataField = 'CROSSMINIMA'
          DataSource = dsPesquisa
          TabOrder = 0
        end
        object edVirtualMaxima: TDBEdit
          Left = 24
          Top = 136
          Width = 177
          Height = 27
          DataField = 'CROSSMAXIMA'
          DataSource = dsPesquisa
          TabOrder = 1
        end
      end
      object gbEstoquePersonalizado: TGroupBox
        AlignWithMargins = True
        Left = 509
        Top = 118
        Width = 245
        Height = 203
        Caption = ' Margem Estoque Personalizado'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
        Font.Name = 'Tahoma'
        ...
        object edPersonalizadoMinima: TDBEdit
          Left = 32
          Top = 68
          Width = 177
          Height = 27
          DataField = 'PERSONALIZADAMINIMA'
          DataSource = dsPesquisa
          TabOrder = 0
        end
        object edPersonalizadoMaxima: TDBEdit
          Left = 32
          Top = 136
          Width = 177
          Height = 27
          DataField = 'PERSONALIZADAMAXIMA'
          DataSource = dsPesquisa
          TabOrder = 1
        end
      end
    ...
    object gdPesquisa: TDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = 'Cross M'#237'nima'
          Width = 205
          Visible = True
        end
        item
          ...
          Title.Caption = 'Cross M'#225'xima'
          Width = 205
          Visible = True
        end
        item
          ...
          Title.Caption = 'F'#237'sico M'#237'nima'
          Width = 205
          Visible = True
        end
        item
          ...
          Title.Caption = 'F'#237'sico M'#225'xima'
          Width = 205
          Visible = True
        end
        item
          ...
          Title.Caption = 'Personalizada M'#237'nima'
          Width = 205
          Visible = True
        end
        item
          ...
          Title.Caption = 'Personalizada M'#225'xima'
          Width = 205
          Visible = True
        end>
    end
