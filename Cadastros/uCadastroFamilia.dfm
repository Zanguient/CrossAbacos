object FrmCadastroFamilia: TFrmCadastroFamilia
    ...
    object Panel1: TPanel
      ...
      object Panel5: TPanel
        ...
        object Label1: TLabel
          ...
          Height = 19
          Align = alTop
          Caption = 'C'#243'digo Margem'
          FocusControl = edCodigoMargem
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -16
          Font.Name = 'Tahoma'
        ...
        object Label2: TLabel
          ...
          Align = alTop
          Alignment = taCenter
          Caption = 'Para selecionar a margem, execute o Duplo Clique na Margem.'
          Font.Charset = DEFAULT_CHARSET
      ...
      object Panel6: TPanel
        ...
        object gdMargens: TDBGrid
          ...
          Columns = <
            ...
            item
              Expanded = False
              FieldName = 'CROSSMINIMA'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'CROSSMAXIMA'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'FISICOMINIMA'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'FISICOMAXIMA'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'PERSONALIZADAMINIMA'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'PERSONALIZADAMAXIMA'
              Visible = True
            end>
        end
  ...
  object csPesquisa: TClientDataSet
    ...
    object csPesquisaDESCRICAO: TStringField
      DisplayLabel = 'Descri'#231#227'o'
      DisplayWidth = 50
      FieldName = 'DESCRICAO'
      Size = 100
    end
    object csPesquisaCODIGOABACOS: TIntegerField
      FieldName = 'CODIGOABACOS'
    end
    object csPesquisaCODIGOMARGEM: TIntegerField
      FieldName = 'CODIGOMARGEM'
    end
    object csPesquisaCROSSMINIMA: TCurrencyField
      DisplayLabel = 'Cross M'#237'nima'
      FieldName = 'CROSSMINIMA'
      DisplayFormat = '0.00'
    end
    object csPesquisaCROSSMAXIMA: TCurrencyField
      DisplayLabel = 'Cross M'#225'xima'
      FieldName = 'CROSSMAXIMA'
      DisplayFormat = '0.00'
    end
    object csPesquisaFISICOMINIMA: TCurrencyField
      DisplayLabel = 'F'#237'sico M'#237'nima'
      FieldName = 'FISICOMINIMA'
      DisplayFormat = '0.00'
    end
    object csPesquisaFISICOMAXIMA: TCurrencyField
      DisplayLabel = 'F'#237'sico M'#225'xima'
      FieldName = 'FISICOMAXIMA'
      DisplayFormat = '0.00'
    end
    object csPesquisaPERSONALIZADAMINIMA: TCurrencyField
      DisplayLabel = 'Personalizada M'#237'nima'
      FieldName = 'PERSONALIZADAMINIMA'
      DisplayFormat = '0.00'
    end
    object csPesquisaPERSONALIZADAMAXIMA: TCurrencyField
      DisplayLabel = 'Personalizada M'#225'xima'
      FieldName = 'PERSONALIZADAMAXIMA'
      DisplayFormat = '0.00'
    end
  end
  object dsMargens: TDataSource
    DataSet = csMargens
    Left = 296
    Top = 192
  end
  object csMargens: TClientDataSet
    Aggregates = <>
    Params = <>
    OnFilterRecord = csPesquisaFilterRecord
    Left = 376
    Top = 192
    object csMargensCODIGO: TIntegerField
      DisplayLabel = 'C'#243'digo'
      FieldName = 'CODIGO'
    end
    object csMargensDESCRICAO: TStringField
      DisplayLabel = 'Descri'#231#227'o'
      DisplayWidth = 50
      FieldName = 'DESCRICAO'
      Size = 100
    end
    object csMargensCROSSMINIMA: TCurrencyField
      DisplayLabel = 'Cross M'#237'nima'
      FieldName = 'CROSSMINIMA'
      DisplayFormat = '0.00'
    end
    object csMargensCROSSMAXIMA: TCurrencyField
      DisplayLabel = 'Cross M'#225'xima'
      FieldName = 'CROSSMAXIMA'
      DisplayFormat = '0.00'
    end
    object csMargensFISICOMINIMA: TCurrencyField
      DisplayLabel = 'F'#237'sico M'#237'nima'
      FieldName = 'FISICOMINIMA'
      DisplayFormat = '0.00'
    end
    object csMargensFISICOMAXIMA: TCurrencyField
      DisplayLabel = 'F'#237'sico M'#225'xima'
      FieldName = 'FISICOMAXIMA'
      DisplayFormat = '0.00'
    end
    object csMargensPERSONALIZADAMINIMA: TCurrencyField
      DisplayLabel = 'Personalizada M'#237'nima'
      FieldName = 'PERSONALIZADAMINIMA'
      DisplayFormat = '0.00'
    end
    object csMargensPERSONALIZADAMAXIMA: TCurrencyField
      DisplayLabel = 'Personalizada M'#225'xima'
      FieldName = 'PERSONALIZADAMAXIMA'
      DisplayFormat = '0.00'
    end
