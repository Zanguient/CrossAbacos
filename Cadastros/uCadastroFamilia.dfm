object FrmCadastroFamilia: TFrmCadastroFamilia
  Left = 0
  Top = 0
  ActiveControl = edPesquisa
  BorderStyle = bsNone
  Caption = 'Cadastro Familias'
  ClientHeight = 504
  ClientWidth = 861
  Color = clBtnFace
  ...
  object ds_Familias: TDataSource
    DataSet = cds_Familias
    Left = 296
    Top = 192
  end
  object cds_Familias: TClientDataSet
    Aggregates = <>
    Params = <>
    OnFilterRecord = csPesquisaFilterRecord
    Left = 376
    Top = 192
    object cds_FamiliasID: TIntegerField
      DisplayLabel = 'C'#243'digo'
      FieldName = 'ID'
    end
    object cds_FamiliasDESCRICAO: TStringField
    ...
    object cds_FamiliasDATAAUTORIZADO: TDateTimeField
